...
namespace Formulário_Inicial.ServiceReference2 {
    ...
    public interface IService1 {
        ...
        void SignUp(Formulário_Inicial.ServiceReference2.Utilizador utilizador, string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/SignUp", ReplyAction="http://tempuri.org/IService1/SignUpResponse")]
        System.Threading.Tasks.Task SignUpAsync(Formulário_Inicial.ServiceReference2.Utilizador utilizador, string token);
        ...
        Formulário_Inicial.ServiceReference2.Funcionario[] GetNumFuncionarioPorData(int dataInicio, int dataFim, string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetNumFuncionarioPorData", ReplyAction="http://tempuri.org/IService1/GetNumFuncionarioPorDataResponse")]
        System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Funcionario[]> GetNumFuncionarioPorDataAsync(int dataInicio, int dataFim, string token);
        ...
        Formulário_Inicial.ServiceReference2.Funcionario[] GetNumFuncCategoriaPorData(int dataInicio, int dataFim, string categoria, string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetNumFuncCategoriaPorData", ReplyAction="http://tempuri.org/IService1/GetNumFuncCategoriaPorDataResponse")]
        System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Funcionario[]> GetNumFuncCategoriaPorDataAsync(int dataInicio, int dataFim, string categoria, string token);
        ...
        Formulário_Inicial.ServiceReference2.Funcionario[] GetMediaFuncionarioPorData(int dataInicio, int dataFim, string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetMediaFuncionarioPorData", ReplyAction="http://tempuri.org/IService1/GetMediaFuncionarioPorDataResponse")]
        System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Funcionario[]> GetMediaFuncionarioPorDataAsync(int dataInicio, int dataFim, string token);
        ...
        Formulário_Inicial.ServiceReference2.Funcionario[] GetPercentagemPessoalPorData(int dataInicio, int dataFim, string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetPercentagemPessoalPorData", ReplyAction="http://tempuri.org/IService1/GetPercentagemPessoalPorDataResponse")]
        System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Funcionario[]> GetPercentagemPessoalPorDataAsync(int dataInicio, int dataFim, string token);
        ...
        Formulário_Inicial.ServiceReference2.Medicamento[] GetPercentagemMedicamentosPorData(int dataInicio, int dataFim, string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetPercentagemMedicamentosPorData", ReplyAction="http://tempuri.org/IService1/GetPercentagemMedicamentosPorDataResponse")]
        System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Medicamento[]> GetPercentagemMedicamentosPorDataAsync(int dataInicio, int dataFim, string token);
        ...
        Formulário_Inicial.ServiceReference2.Cama[] GetMediaCamasPorData(int dataInicio, int dataFim, string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetMediaCamasPorData", ReplyAction="http://tempuri.org/IService1/GetMediaCamasPorDataResponse")]
        System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Cama[]> GetMediaCamasPorDataAsync(int dataInicio, int dataFim, string token);
        ...
        Formulário_Inicial.ServiceReference2.Funcionario[] GetRacioFuncionariosPorData(int dataInicio, int dataFim, string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetRacioFuncionariosPorData", ReplyAction="http://tempuri.org/IService1/GetRacioFuncionariosPorDataResponse")]
        System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Funcionario[]> GetRacioFuncionariosPorDataAsync(int dataInicio, int dataFim, string token);
        ...
        Formulário_Inicial.ServiceReference2.Acao[] GetAcoesCategoriaPorData(int dataInicio, int dataFim, string categoria, string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetAcoesCategoriaPorData", ReplyAction="http://tempuri.org/IService1/GetAcoesCategoriaPorDataResponse")]
        System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Acao[]> GetAcoesCategoriaPorDataAsync(int dataInicio, int dataFim, string categoria, string token);
        ...
        Formulário_Inicial.ServiceReference2.Acao[] GetPercentagemAcoesPorData(int dataInicio, int dataFim, string categoria, string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetPercentagemAcoesPorData", ReplyAction="http://tempuri.org/IService1/GetPercentagemAcoesPorDataResponse")]
        System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Acao[]> GetPercentagemAcoesPorDataAsync(int dataInicio, int dataFim, string categoria, string token);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IService1Channel : Formulário_Inicial.ServiceReference2.IService1, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Service1Client : System.ServiceModel.ClientBase<Formulário_Inicial.ServiceReference2.IService1>, Formulário_Inicial.ServiceReference2.IService1 {
        ...
        public void SignUp(Formulário_Inicial.ServiceReference2.Utilizador utilizador, string token) {
            base.Channel.SignUp(utilizador, token);
        }
        
        public System.Threading.Tasks.Task SignUpAsync(Formulário_Inicial.ServiceReference2.Utilizador utilizador, string token) {
        ...
        public Formulário_Inicial.ServiceReference2.Funcionario[] GetNumFuncionarioPorData(int dataInicio, int dataFim, string token) {
            return base.Channel.GetNumFuncionarioPorData(dataInicio, dataFim, token);
        }
        
        public System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Funcionario[]> GetNumFuncionarioPorDataAsync(int dataInicio, int dataFim, string token) {
            return base.Channel.GetNumFuncionarioPorDataAsync(dataInicio, dataFim, token);
        }
        
        public Formulário_Inicial.ServiceReference2.Funcionario[] GetNumFuncCategoriaPorData(int dataInicio, int dataFim, string categoria, string token) {
            return base.Channel.GetNumFuncCategoriaPorData(dataInicio, dataFim, categoria, token);
        }
        
        public System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Funcionario[]> GetNumFuncCategoriaPorDataAsync(int dataInicio, int dataFim, string categoria, string token) {
            return base.Channel.GetNumFuncCategoriaPorDataAsync(dataInicio, dataFim, categoria, token);
        }
        
        public Formulário_Inicial.ServiceReference2.Funcionario[] GetMediaFuncionarioPorData(int dataInicio, int dataFim, string token) {
            return base.Channel.GetMediaFuncionarioPorData(dataInicio, dataFim, token);
        }
        
        public System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Funcionario[]> GetMediaFuncionarioPorDataAsync(int dataInicio, int dataFim, string token) {
            return base.Channel.GetMediaFuncionarioPorDataAsync(dataInicio, dataFim, token);
        }
        
        public Formulário_Inicial.ServiceReference2.Funcionario[] GetPercentagemPessoalPorData(int dataInicio, int dataFim, string token) {
            return base.Channel.GetPercentagemPessoalPorData(dataInicio, dataFim, token);
        }
        
        public System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Funcionario[]> GetPercentagemPessoalPorDataAsync(int dataInicio, int dataFim, string token) {
            return base.Channel.GetPercentagemPessoalPorDataAsync(dataInicio, dataFim, token);
        }
        
        public Formulário_Inicial.ServiceReference2.Medicamento[] GetPercentagemMedicamentosPorData(int dataInicio, int dataFim, string token) {
            return base.Channel.GetPercentagemMedicamentosPorData(dataInicio, dataFim, token);
        }
        
        public System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Medicamento[]> GetPercentagemMedicamentosPorDataAsync(int dataInicio, int dataFim, string token) {
            return base.Channel.GetPercentagemMedicamentosPorDataAsync(dataInicio, dataFim, token);
        }
        
        public Formulário_Inicial.ServiceReference2.Cama[] GetMediaCamasPorData(int dataInicio, int dataFim, string token) {
            return base.Channel.GetMediaCamasPorData(dataInicio, dataFim, token);
        }
        
        public System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Cama[]> GetMediaCamasPorDataAsync(int dataInicio, int dataFim, string token) {
            return base.Channel.GetMediaCamasPorDataAsync(dataInicio, dataFim, token);
        }
        
        public Formulário_Inicial.ServiceReference2.Funcionario[] GetRacioFuncionariosPorData(int dataInicio, int dataFim, string token) {
            return base.Channel.GetRacioFuncionariosPorData(dataInicio, dataFim, token);
        }
        
        public System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Funcionario[]> GetRacioFuncionariosPorDataAsync(int dataInicio, int dataFim, string token) {
            return base.Channel.GetRacioFuncionariosPorDataAsync(dataInicio, dataFim, token);
        }
        
        public Formulário_Inicial.ServiceReference2.Acao[] GetAcoesCategoriaPorData(int dataInicio, int dataFim, string categoria, string token) {
            return base.Channel.GetAcoesCategoriaPorData(dataInicio, dataFim, categoria, token);
        }
        
        public System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Acao[]> GetAcoesCategoriaPorDataAsync(int dataInicio, int dataFim, string categoria, string token) {
            return base.Channel.GetAcoesCategoriaPorDataAsync(dataInicio, dataFim, categoria, token);
        }
        
        public Formulário_Inicial.ServiceReference2.Acao[] GetPercentagemAcoesPorData(int dataInicio, int dataFim, string categoria, string token) {
            return base.Channel.GetPercentagemAcoesPorData(dataInicio, dataFim, categoria, token);
        }
        
        public System.Threading.Tasks.Task<Formulário_Inicial.ServiceReference2.Acao[]> GetPercentagemAcoesPorDataAsync(int dataInicio, int dataFim, string categoria, string token) {
